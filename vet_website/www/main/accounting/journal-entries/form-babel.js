...
class JournalEntry extends React.Component {
    ...
    formSubmit(e) {
        ...
        var total_debit = new_data.journal_items.filter(a => !a.delete).reduce((total, j) => total+=parseFloat(j.debit||'0.0'),0.0)
        var total_credit = new_data.journal_items.filter(a => !a.delete).reduce((total, j) => total+=parseFloat(j.credit||'0.0'),0.0)
