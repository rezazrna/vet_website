            ...
            return <form id="grooming_form" onSubmit={(e) => this.editGrooming(e)}>
            	...
            	<div className="row">
            	    <div className={rekam_medis_class}>
            	        <Pengecekan write={write} grooming={this.state.data.grooming} handleInputChange={this.handleInputChange} grooming_data={this.state.grooming_data} handleInputBlur={this.handleInputBlur} addMarker={this.addMarker} markers={this.state.markers} addCheck={this.addCheck} deleteCheck={this.deleteCheck} checks={this.state.checks} deleteAttachment={this.deleteAttachment} addAttachment={this.addAttachment} addMarker={this.addMarker} resetMarker={this.resetMarker} toggleRekamMedisWide={() => this.toggleRekamMedisWide()} />
            	    </div>
            	    <div className="col-6">
