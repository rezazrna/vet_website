...
class Operation extends React.Component {
    ...
    componentDidMount() {
        ...
        frappe.call({
            ...
            callback: function(r){
                if (r.message) {
                    var namelist = r.message.operation.map(r => r.name)
