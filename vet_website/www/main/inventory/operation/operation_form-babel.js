...
class FormOperation extends React.Component {
    ...
    render() {
        ...
        if (id == undefined || (this.props.usage && this.props.edit_mode)){
            ...
            to = <input readOnly={this.props.usage}  type="text" name="to" id="to" autoComplete="off" placeholder="To" className="form-control fs14" list="gudang" defaultValue={data.to_name||''} onChange={e => this.props.changeInput(e)} onBlur={e => this.props.inputBlur(e, gudang_list)}/>
