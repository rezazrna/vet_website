...
class CustomerInvoice extends React.Component {
    ...
    depositExchange(e){
        ...
        var exchange = parseFloat(paid) - parseFloat(this.state.data.total)
    ...
    //     )
        ...
        if(!children_customer_invoice || children_customer_invoice.length == 0){
            content = <div style={panel_style} className="p-4 mb-4">
                             ...
                             */}
                            <CustomerInvoiceLinesContent list={list.farmasi} edit_mode={this.props.edit_mode} product_list={this.props.product_list} uom_list={this.props.uom_list} status={this.props.status} payments={this.props.payments} subtotal={this.props.subtotal} paid={this.props.paid} changeInput={this.props.changeInput} inputBlur={this.props.inputBlur} service_name="Farmasi" service="farmasi" warehouse_list={this.props.warehouse_list} is_refund={this.props.is_refund} no_exchange={this.props.no_exchange} potongan={this.props.potongan} deleteRow={(index) => this.props.deleteRow(index, 'farmasi')} role={this.props.role} links={parent_links} register_number={this.props.register_number}/>
                			<CustomerInvoiceLinesContent list={list.jasa} edit_mode={this.props.edit_mode} product_list={this.props.product_list} uom_list={this.props.uom_list} status={this.props.status} payments={this.props.payments} subtotal={this.props.subtotal} paid={this.props.paid} changeInput={this.props.changeInput} inputBlur={this.props.inputBlur} service_name={this.props.service||"Jasa"} service="jasa" warehouse_list={this.props.warehouse_list} is_refund={this.props.is_refund} no_exchange={this.props.no_exchange} potongan={this.props.potongan} deleteRow={(index) => this.props.deleteRow(index, 'jasa')} role={this.props.role} links={parent_links} register_number={this.props.register_number}/>
...
class PopupPay extends React.Component {
    ...
    submitPay(e) {
        ...
        if(['',undefined,null].includes(this.state.data.jumlah)){
            var new_data = Object.assign({}, this.state.data)
            new_data.jumlah = parseFloat(remaining).toLocaleString('id-ID')
            ...
            new_data.jumlah = parseFloat(this.reverseFormatNumber(new_data.jumlah, 'id'))
