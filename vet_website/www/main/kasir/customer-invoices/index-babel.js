        ...
        if (this.state.loaded){
            return(
                <div>
                    ...
                    <CustomerInvoiceList invoices={this.state.data} search={this.state.search} checkRow={this.checkRow} checkAll={() => this.checkAll()} check_all={this.state.check_all} paginationClick={this.paginationClick} currentpage={this.state.currentpage} rawat_inap={this.props.rawat_inap} datalength={this.state.datalength}/>
