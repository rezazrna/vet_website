...
class DataPemilik extends React.Component {
    ...
    render() {
        ...
        if (mode == 'New') {
            ...
            inputAlamat = <textarea readOnly={this.props.data_exist} id="address" name='address' className="form-control border-0 lightbg" rows="3" onChange={this.props.handleInputChange} value={newOwner.address || ''} onKeyDown={this.props.nextInput}></textarea>
            ...
            inputEmail = <input readOnly={this.props.data_exist} id="email" name='email' type="email" className="form-control border-0 lightbg " onChange={this.props.handleInputChange} value={newOwner.email || ''}/>
            inputAlamat = <textarea readOnly={this.props.data_exist} id="address" name='address' className="form-control border-0 lightbg" rows="3" onChange={this.props.handleInputChange} value={newOwner.address || ''}></textarea>
            if (mode == 'New Pet'){
            ...
            inputAlamat = <textarea id="address" name='address' className={modeEditPet ? 'form-control border-0 lightbg ' : 'form-control border-0'} rows="3" defaultValue={newOwner.address} onChange={this.props.handleInputChange} readOnly={!modeEditPet}></textarea>
