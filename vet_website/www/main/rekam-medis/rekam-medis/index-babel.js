...
class RekamMedis extends React.Component {
    ...
    render() {
		...
		var content
		if(pet){
		    content = <RekamMedisListExpandable data={this.state.data} search={this.state.search} expandRow={this.expandRow} expandAll={() => this.expandAll()} expand_all={this.state.expand_all} paginationClick={this.paginationClick} currentpage={this.state.currentpage} datalength={this.state.datalength}/>
		}
		else{
		    content = <RekamMedisList data={this.state.data} search={this.state.search} checkRow={this.checkRow} checkAll={() => this.checkAll()} check_all={this.state.check_all} paginationClick={this.paginationClick} currentpage={this.state.currentpage} datalength={this.state.datalength}/>
		}
